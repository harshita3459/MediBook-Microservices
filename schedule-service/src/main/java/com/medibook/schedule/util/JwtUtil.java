package com.medibook.schedule.util;
...
/** JWT validation only — same secret as auth-service. Never generates tokens. */
@Component
@Slf4j
public class JwtUtil {
    ...
    public boolean validateToken(String token) {
        ...
        catch (Exception e) { log.warn("Token invalid: {}", e.getMessage()); return false; }
    }
