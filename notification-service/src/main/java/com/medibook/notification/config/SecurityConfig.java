...
import com.medibook.notification.util.JwtUtil;
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers(HttpMethod.POST,
                    ...
                    "/api/v1/notifications/appointment-event",
                    "/api/v1/notifications/payment-event"
                ).permitAll()
                .requestMatchers(
                    "/v3/api-docs/**",
                    "/swagger-ui/**",
    ...
    protected void doFilterInternal(HttpServletRequest req,
        ...
        if (gatewayRole != null && !gatewayRole.isBlank()) {
            var auth = new UsernamePasswordAuthenticationToken(
                req.getHeader("X-Authenticated-User"),
                null,
